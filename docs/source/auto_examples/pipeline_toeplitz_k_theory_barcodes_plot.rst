...
.. "auto_examples/pipeline_toeplitz_k_theory_barcodes_plot.py"
...
.. only:: html
    ...
    .. note::
        ...
        :ref:`Go to the end <sphx_glr_download_auto_examples_pipeline_toeplitz_k_theory_barcodes_plot.py>`
        to download the full example code.

.. rst-class:: sphx-glr-example-title

.. _sphx_glr_auto_examples_pipeline_toeplitz_k_theory_barcodes_plot.py:
...
.. rst-class:: sphx-glr-horizontal
    ...
    *
      ...
      .. image-sg:: /auto_examples/images/sphx_glr_pipeline_toeplitz_k_theory_barcodes_plot_001.png
         :alt: Toeplitz graph K0 ⊗ F_2 barcode
         :srcset: /auto_examples/images/sphx_glr_pipeline_toeplitz_k_theory_barcodes_plot_001.png
         :class: sphx-glr-multi-img

    *

      .. image-sg:: /auto_examples/images/sphx_glr_pipeline_toeplitz_k_theory_barcodes_plot_002.png
         :alt: Toeplitz graph K1 ⊗ F_2 barcode
         :srcset: /auto_examples/images/sphx_glr_pipeline_toeplitz_k_theory_barcodes_plot_002.png
         :class: sphx-glr-multi-img
...
.. only:: html
  ...
  .. container:: sphx-glr-footer sphx-glr-footer-example
    ...
    .. container:: sphx-glr-download sphx-glr-download-jupyter
      ...
      :download:`Download Jupyter notebook: pipeline_toeplitz_k_theory_barcodes_plot.ipynb <pipeline_toeplitz_k_theory_barcodes_plot.ipynb>`

    .. container:: sphx-glr-download sphx-glr-download-python

      :download:`Download Python source code: pipeline_toeplitz_k_theory_barcodes_plot.py <pipeline_toeplitz_k_theory_barcodes_plot.py>`

    .. container:: sphx-glr-download sphx-glr-download-zip

      :download:`Download zipped: pipeline_toeplitz_k_theory_barcodes_plot.zip <pipeline_toeplitz_k_theory_barcodes_plot.zip>`
