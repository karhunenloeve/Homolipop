...
.. "auto_examples/persistence_triangle_F5.py"
...
.. only:: html
    ...
    .. note::
        ...
        :ref:`Go to the end <sphx_glr_download_auto_examples_persistence_triangle_F5.py>`
        to download the full example code.

.. rst-class:: sphx-glr-example-title

.. _sphx_glr_auto_examples_persistence_triangle_F5.py:
...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    Pairs (birth, death, dim) over F5:
    (1, 3, 0)
    (2, 4, 0)
    (5, 6, 1)
    Unpaired (birth, dim) over F5:
    (0, 0)
...
.. only:: html
  ...
  .. container:: sphx-glr-footer sphx-glr-footer-example
    ...
    .. container:: sphx-glr-download sphx-glr-download-jupyter
      ...
      :download:`Download Jupyter notebook: persistence_triangle_F5.ipynb <persistence_triangle_F5.ipynb>`

    .. container:: sphx-glr-download sphx-glr-download-python

      :download:`Download Python source code: persistence_triangle_F5.py <persistence_triangle_F5.py>`

    .. container:: sphx-glr-download sphx-glr-download-zip

      :download:`Download zipped: persistence_triangle_F5.zip <persistence_triangle_F5.zip>`
