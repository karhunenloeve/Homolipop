...
.. "auto_examples/mnist_two_class_concentric_rings.py"
...
.. only:: html
    ...
    .. note::
        ...
        :ref:`Go to the end <sphx_glr_download_auto_examples_mnist_two_class_concentric_rings.py>`
        to download the full example code.

.. rst-class:: sphx-glr-example-title

.. _sphx_glr_auto_examples_mnist_two_class_concentric_rings.py:
...
.. GENERATED FROM PYTHON SOURCE LINES 123-266



.. image-sg:: /auto_examples/images/sphx_glr_mnist_two_class_concentric_rings_001.png
   :alt: MNIST digit 3, MNIST digit 8
   :srcset: /auto_examples/images/sphx_glr_mnist_two_class_concentric_rings_001.png
...
.. only:: html
  ...
  .. container:: sphx-glr-footer sphx-glr-footer-example
    ...
    .. container:: sphx-glr-download sphx-glr-download-jupyter
      ...
      :download:`Download Jupyter notebook: mnist_two_class_concentric_rings.ipynb <mnist_two_class_concentric_rings.ipynb>`

    .. container:: sphx-glr-download sphx-glr-download-python

      :download:`Download Python source code: mnist_two_class_concentric_rings.py <mnist_two_class_concentric_rings.py>`

    .. container:: sphx-glr-download sphx-glr-download-zip

      :download:`Download zipped: mnist_two_class_concentric_rings.zip <mnist_two_class_concentric_rings.zip>`
